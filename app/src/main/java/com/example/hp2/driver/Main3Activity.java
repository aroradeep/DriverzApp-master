...
public class Main3Activity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        f3 = new Firebase("https://driverz-a56f8.firebaseio.com/AppUser");
        mAuthListener= new FirebaseAuth.AuthStateListener() {
            @Override
            public void onAuthStateChanged(@NonNull FirebaseAuth firebaseAuth) {
                if(firebaseAuth.getCurrentUser()==null){
                    Intent login=new Intent(Main3Activity.this,loginuser.class);
...
*/
    ...
    public boolean onOptionsItemSelected(MenuItem item) {
        ...
        switch (id){
            case R.id.allSongs:
                ...
                break;
            case R.id.fav:
                Intent login10=new Intent(Main3Activity.this,CustomerMapActivity.class);
                login10.addFlags(Intent.FLAG_ACTIVITY_CLEAR_TOP);
                startActivity(login10);
                break;
            case R.id.artist:
                Intent login2=new Intent(Main3Activity.this,CustomerSettingsActivity.class);
                login2.addFlags(Intent.FLAG_ACTIVITY_CLEAR_TOP);
                startActivity(login2);
                break;
            case R.id.views:
                Intent intent=new Intent(Main3Activity.this,HistoryActivity.class);
    ...
    public void Data(){
        ...
        if (user != null) {
            ...
            mDatabaseReference= FirebaseDatabase.getInstance().getReference().child("AppUser").child(userid);
            ...
            com.google.firebase.database.ValueEventListener post = new com.google.firebase.database.ValueEventListener() {
                ...
                public void onDataChange(com.google.firebase.database.DataSnapshot dataSnapshot) {
                    ...
                    Log.v("E_value", "emailll" +name);
                    Log.v("E_value", "emaillll" +email);
                }
